...
public class IterateUsingLambda {
    public static void main(String[] args) {
        ...
        System.out.println("Iterate without using Lambda");
        ...
        System.out.println("Lambda Iteration on itemPrice map");

        itemPrice.forEach((Item,price) -> System.out.println("Item Name: " + Item + " and Price: " + price));
